...
<div class="overlay" overlay-id="anal">
    <div class="popup">
        <div>
            ...
            <hr/>
            <ul class="menu">
                <li><a transition href="">Физическая охрана</a></li>
                <li><a transition href="">Пультовая охрана</a></li>
                <li><a transition href="">Система видеонаблюдения</a></li>
                <li><a transition href="">Охрано-пожарной система</a></li>
                <li><a transition href="">Инкассация</a></li>
                <li><a transition href="">Полиграф детектор лжи</a></li>
            </ul>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if ((isEmpty(document.referrer) || isEmpty(host) || !document.referrer.includes(host)) && body.attr("debug") != "true"){
        $(`<div id="plug"></div>
        <div id="logo-box">
